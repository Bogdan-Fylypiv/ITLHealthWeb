    ...
    <div class="orders-container">
        ...
        <div class="filter-section">
            ...
            <div class="filter-row">
                <div class="filter-group business-group">
                    <span class="filter-label">Business:</span>
                    <asp:CheckBoxList ID="CblBusiness" runat="server" 
                        RepeatDirection="Horizontal"
                        RepeatLayout="Flow"
                        CssClass="business-filter"
                        aria-label="Select business units">
                    </asp:CheckBoxList>
                </div>
            </div>
            
            <!-- Date Filters and Buttons Row -->
            <div class="filter-row">
            ...
            <h3>Orders</h3>
                <div class="grid-container">
                    <asp:GridView ID="GvOrders" runat="server" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="OrderID" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <%# Eval("OrderID") %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="ShippedDate" HeaderText="Completed" 
                                DataFormatString="{0:dd-MMM-yyyy}" 
                                ItemStyle-Width="90px" 
                                ItemStyle-HorizontalAlign="Center" />
            
                            <asp:BoundField DataField="ShipDate" HeaderText="Shipped On" 
                                DataFormatString="{0:dd-MMM-yyyy}" 
                                ItemStyle-Width="90px" 
                                ItemStyle-HorizontalAlign="Center" />
            
                            <asp:TemplateField HeaderText="Ship From" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <%# GetWarehouseName(Eval("ShipFrom")) %>
                                </ItemTemplate>
                            </asp:TemplateField>
